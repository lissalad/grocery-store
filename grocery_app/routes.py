...
def new_item():
    ...
    if request.method == 'POST':
      ...
      # if form.validate_on_submit():
        ...
        return redirect(url_for('main.item_detail', form=form, item_id=new_item.id))
...
def store_detail(store_id):
    ...
    if request.method == 'POST':
      ...
      return redirect(url_for('main.store_detail', store_id=store.id, form=form))
...
def item_detail(item_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('main.item_detail', form=form, item_id=item.id))
